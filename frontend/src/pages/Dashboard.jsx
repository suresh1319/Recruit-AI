            ...
            <main className="flex-1 overflow-y-auto w-full">
                ...
                <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6">
                    ...
                    {activeTab === 'home' && (
                        <>
                            {/* Welcome Banner */}
                            <div className="bg-gradient-to-r from-violet-600 to-indigo-600 rounded-2xl p-6 md:p-10 text-white shadow-sm relative overflow-hidden">
                                <div className="relative z-10">
                                    <h2 className="text-2xl md:text-3xl font-bold mb-2 tracking-tight">Welcome back! 👋</h2>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                                ...
                                <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between h-36">
                                    <div className="flex items-center justify-between">
                                        <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Active Jobs</p>
                                ...
                                <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between h-36">
                                    <div className="flex items-center justify-between">
                                        <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Screening Rate</p>
                            ...
                            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                                <div className="p-6 border-b border-slate-100 dark:border-slate-800 font-bold text-slate-900 dark:text-slate-100 text-base">
                                    Recent Activity
                                </div>
                                <div className="divide-y divide-slate-100 dark:divide-slate-800">
                                    {isLoading ? (
                                        ...
                                        metrics.recentActivity.map((item, idx) => (
                                            <div key={idx} className="p-4 md:p-6 flex items-start gap-4">
                                                <div className={`mt-1 flex-shrink-0 ${item.icon === 'Calendar' ? 'text-blue-500' :
                                                    item.icon === 'Users' ? 'text-purple-500' :
                                                        item.icon === 'Clock' ? 'text-orange-500' : 'text-emerald-500'
                                                    }`}>
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">{getRelativeTime(item.time)}</p>
                                                </div>
                                            </div>
                                        ))
                                    ) : (
